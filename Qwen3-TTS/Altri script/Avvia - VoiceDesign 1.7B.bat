...
echo [Qwen3-TTS] Modello: VoiceDesign
echo [Qwen3-TTS] Server: http://0.0.0.0:8000
uv run python -m qwen_tts.server --models "vd=Qwen/Qwen3-TTS-12Hz-1.7B-VoiceDesign" --host 0.0.0.0 --port 8000 --device %DEVICE% --dtype %DTYPE% %FLASH%
