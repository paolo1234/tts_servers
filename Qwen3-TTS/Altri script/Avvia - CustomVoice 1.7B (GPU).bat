...
:: Flash attention solo per GPU Ampere+ (CC >= 8)
...
uv run python -m qwen_tts.server --models "cv=Qwen/Qwen3-TTS-12Hz-1.7B-CustomVoice" --host 0.0.0.0 --port 8000 --device %DEVICE% --dtype %DTYPE% %FLASH%
