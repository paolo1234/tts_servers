...
echo [Qwen3-TTS] Modello: Base (Voice Clone)
echo [Qwen3-TTS] Server: http://0.0.0.0:8000
uv run python -m qwen_tts.server --models "base=Qwen/Qwen3-TTS-12Hz-1.7B-Base" --host 0.0.0.0 --port 8000 --device %DEVICE% --dtype %DTYPE% %FLASH%
